<x-layouts::app :title="__('Edit Post')">
    ...
    <form method="POST" action="{{ route('admin.posts.update', $post) }}" class="mt-8 max-w-2xl space-y-6">
        @csrf
        @method('PUT')
        ...
        <flux:field>
            ...
            <flux:input type="text" name="image" value="{{ old('image', $post->image) }}" placeholder="https://..." required />
