...
use App\Models\VrtoolLike;
use Illuminate\Support\Facades\Auth;
use Livewire\Component;

new class extends Component
{
    public Vrtool $vrtool;
    ...
    public function mount(Vrtool $vrtool): void
    {
        $this->vrtool = $vrtool->loadCount('vrtoolLikes');

        $this->likesCount = $vrtool->vrtool_likes_count;

        if (Auth::check()) {
            $like = VrtoolLike::where('vrtool_id', $vrtool->id)
    ...
    public function toggleLike(): void
    {
        ...
        if ($this->userLikedId) {
            VrtoolLike::where('id', $this->userLikedId)->delete();
            $this->userLikedId = null;
            $this->likesCount--;
        } else {
            $like = VrtoolLike::create([
                'vrtool_id' => $this->vrtool->id,
                'user_id' => Auth::id(),
            ]);
            $this->userLikedId = $like->id;
            $this->likesCount++;
    ...
    {
        $comment = VrtoolComment::findOrFail($commentId);
