<x-layouts::public :title="__($post->title)">
    <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">

        <a href="{{ route('posts.index') }}" class="text-indigo-600 hover:text-indigo-800 text-sm font-medium inline-flex items-center gap-1 mb-6">
            ...
            <div class="p-6 md:p-10">
                <div class="flex flex-wrap items-center gap-3 mb-2">
                    ...
                    <div>
                        ...
                        <span class="text-gray-400 text-xs block">{{ $post->published_at?->diffForHumans() ?? __('Unpublished') }}</span>
                    </div>
                </div>

                <h1 class="text-3xl md:text-4xl font-bold mt-4 mb-3">{{ $post->title }}</h1>
