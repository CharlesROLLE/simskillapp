<x-layouts::public :title="__('Approaches')">
    <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        ...
        <div class="border-b mb-5 flex justify-between text-sm">
            <div class="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
                ...
                <span class="font-semibold inline-block">Approaches</span>
            </div>
            <a href="#">See All</a>
        </div>
                ...
                <div class="rounded overflow-hidden shadow-lg flex flex-col">
                    ...
                    <div class="px-6 py-4 mb-auto">
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <span class="text-gray-400 text-sm">| {{ $approach->city }}, {{ $approach->country }}</span>
                        </div>
                    ...
                    <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                        <span class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                            <svg height="13px" width="13px" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                                <g>
                                    <path d="M256,0C114.837,0,0,114.837,0,256s114.837,256,256,256s256-114.837,256-256S397.163,0,256,0z M277.333,256 c0,11.797-9.536,21.333-21.333,21.333h-85.333c-11.797,0-21.333-9.536-21.333-21.333s9.536-21.333,21.333-21.333h64v-128 c0-11.797,9.536-21.333,21.333-21.333s21.333,9.536,21.333,21.333V256z"></path>
                                </g>
                            </svg>
                            <span class="ml-1">{{ $approach->charts->count() }} charts</span>
                        </span>
                        <span class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                            <svg class="h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path>
                            </svg>
                            <span class="ml-1">{{ $approach->created_at->diffForHumans() }}</span>
                        </span>
                    </div>
                </div>
            @endforeach
